...
- Exemplo do Dia 4: `../Dia4/resumidor_pdf.py`

---

## 💡 Dicas

### Exemplo de Type Hints:
```python
from typing import Optional, List, Dict

def processar_texto(
    texto: str, 
    opcoes: Optional[Dict[str, bool]] = None
) -> List[str]:
    """
    Processa texto e retorna lista de palavras.
    
    Args:
        texto: Texto a ser processado
        opcoes: Opções de processamento (opcional)
...
### Exemplo de Docstring (Google Style):
```python
