...
- **Foco:** Introduzir Agents e uso de múltiplas tools (calculator + RAG) com LangChain.
...
- **Dia 5 (hoje):** Agents e tools (Nível 1 - conceito novo) 🟡
...
- `GUIA_AGENTS.md` - Guia completo sobre Agents (Nível 1)
- `exemplo_completo.py` - Exemplo completo comentado (Nível 1)
- `exercicios.md` - Exercícios guiados progressivos

### 🎯 O que você vai aprender:
1. **Agents e ReAct:** Como Agents raciocinam e escolhem ferramentas.
...
### 💡 Notas Importantes:
- **Baseado em:** Dia 4 (RAG avançado) — o retriever vira uma Tool.
...
- **Pré-requisito:** RAG avançado do Dia 4 funcionando e persistido em `../Dia4/chroma_db`.
