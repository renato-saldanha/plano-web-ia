#!/usr/bin/env python3
"""
API FastAPI com Rate Limiting, Exception Handling e Logging - Exemplo Completo
...
# =============================================================================
app = FastAPI(
    title="API com Rate Limiting e Logging - Referência",
    description="Dia 5 - Exemplo completo",
    version="1.0.0",
)
